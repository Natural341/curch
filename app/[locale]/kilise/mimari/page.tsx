      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <article className="bg-white rounded-xl shadow-sm p-6 md:p-10">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-6">Mimarlar ve Tasarım</h2>
            ...
            <div className="bg-gray-50 rounded-lg p-5 my-8 border border-gray-200">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Neo-Gotik Mimari</h3>
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-6 mt-12">Dış Cephe</h2>
            <p className="text-sm text-gray-600 leading-relaxed mb-4">
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-6 mt-12">İç Mekan</h2>
            <p className="text-sm text-gray-600 leading-relaxed mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-4 mt-10">Duvar Süslemeleri ve Mozaikler</h3>
            <p className="text-sm text-gray-600 leading-relaxed mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-4 mt-10">Heykeller</h3>
            <p className="text-sm text-gray-600 leading-relaxed mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-6 mt-12">Işık ve Akustik</h2>
            <p className="text-sm text-gray-600 leading-relaxed mb-4">
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-6 mt-12">Restorasyon ve Koruma</h2>
            <p className="text-sm text-gray-600 leading-relaxed mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-4 my-10">
              <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
                <h4 className="text-base font-semibold text-gray-900 mb-2">Plan</h4>
                <p className="text-sm text-gray-600">Latin haç planı, 20×50m ölçülerinde</p>
              </div>
              <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
                <h4 className="text-base font-semibold text-gray-900 mb-2">Stil</h4>
                <p className="text-sm text-gray-600">Neo-Gotik / 14. yy Toskana etkileri</p>
              </div>
              <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
                <h4 className="text-base font-semibold text-gray-900 mb-2">Malzeme</h4>
                <p className="text-sm text-gray-600">Kırmızı tuğla dış cephe, betonarme yapı</p>
              </div>
              <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
                <h4 className="text-base font-semibold text-gray-900 mb-2">İnşaat</h4>
                <p className="text-sm text-gray-600">1906-1912, Giulio Mongeri & Eduardo de Nari</p>
              </div>
            </div>

            <div className="bg-gray-50 rounded-lg p-6 my-8 border border-gray-200">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Ziyaret Bilgisi</h3>
              <p className="text-sm text-gray-600 leading-relaxed">
